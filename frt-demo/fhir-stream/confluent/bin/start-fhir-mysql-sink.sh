...
$CONFLUENT_HOME/etc/kafka-connect-jdbc/fhir-groupby-org-gender-mysql-sink.properties \
$CONFLUENT_HOME/etc/kafka-connect-jdbc/fhir-groupby-org-mysql-sink.properties \
$CONFLUENT_HOME/etc/kafka-connect-jdbc/fhir-groupby-gp-gender-mysql-sink.properties \
$CONFLUENT_HOME/etc/kafka-connect-jdbc/fhir-groupby-gp-mysql-sink.properties \
$CONFLUENT_HOME/etc/kafka-connect-jdbc/fhir-groupby-state-gender-mysql-sink.properties \
