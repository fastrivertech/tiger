...
CREATE TABLE PATIENT_CONTACTPOINT (
	...
	cp_system VARCHAR(128), -- Σ change from 'system' to 'cp_system', to avoid splicemachine reserved word
	value VARCHAR(2048), -- Σ
	use VARCHAR(32), -- ?!Σ
	cp_rank INTEGER, -- Σ change to cp_rank to avoid splicemachine reserved words
	period CLOB, -- Σ, Period object serialization and de-serialization 
