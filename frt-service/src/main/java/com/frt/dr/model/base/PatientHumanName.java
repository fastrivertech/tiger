...
public class PatientHumanName implements Serializable {
    ...
    */
    ...
    public String toString() {
		...
		Util.addNVpair(sb, "family", this.getFamily());
		Util.addNVpair(sb, "given", this.getGiven());
		Util.addNVpair(sb, "prefix", this.getPrefix());
		Util.addNVpair(sb, "suffix", this.getSuffix());
